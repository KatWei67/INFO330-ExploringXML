...
<xsl:template match="/pokedex">
    <xsl:apply-templates select="pokemon[type1= 'fire' or type1= 'water' or type1= 'flying' or type1= 'ground' or type2= 'fire' or type2= 'water' or type2= 'flying' or type2= 'ground']" />
</xsl:template>
